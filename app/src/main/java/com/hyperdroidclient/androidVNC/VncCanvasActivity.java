...
import com.hyperdroidclient.data.local.InteractionService;
...
public class VncCanvasActivity extends Activity implements View.OnGenericMotionListener {
    ...
    class ZoomInputHandler extends AbstractGestureInputHandler {
        ...
        public boolean onTouchEvent(MotionEvent e) {
            Log.i("Preempting-User"," Triggered - onTouchEvent() ");
        ...
        public void onLongPress(MotionEvent e) {
            Log.i("Preempting-User"," Triggered - onLongPress() ");
            showZoomer(true);
        ...
        public boolean onScroll(MotionEvent e1, MotionEvent e2,
            ...
            Log.i("Preempting-User"," Triggered - onScroll() ");
            if (inScaling)
                return false;
            showZoomer(false);
        ...
        public boolean onSingleTapConfirmed(MotionEvent e) {
            Log.i("Preempting-User"," Triggered - onSingleTapConfirmed() ");
            vncCanvas.changeTouchCoordinatesToFullFrame(e);
        ...
        public boolean onDoubleTap(MotionEvent e) {
            Log.i("Preempting-User"," Triggered - onDoubleTap() ");
            vncCanvas.changeTouchCoordinatesToFullFrame(e);
    ...
    public void onCreate(Bundle icicle) {
        ...
        // Setup Handler Service for Taking out of context
        startService(new Intent(getApplicationContext(), InteractionService.class));

        // For Stopping The Activity / Finish
        tempobj = this;
    ...
    static VncCanvasActivity tempobj;

    static public void AbortSession()
    {
        tempobj.finish();
    }
    ...
    protected void onDestroy() {
        ...
        if (isFinishing()) {
            ...
            vncCanvas.onDestroy();
            database.close();
            HomeFragment.endSession();
            removeUUID();
        }
        stopService(new Intent(getApplicationContext(), InteractionService.class));
    }
